...
public class Ex07_2 extends JFrame{
	public Ex07_2(){
		...
		JRadioButton jr1 = new JRadioButton("콤보",true);	// 15000원
		JRadioButton jr2 = new JRadioButton("포테이토");	// 20000원
		JRadioButton jr3 = new JRadioButton("불고기");	// 30000원
		
		gb1.add(jr1);		
		gb1.add(jr2);		
		gb1.add(jr3);
		
		JRadioButton jr4 = new JRadioButton("피망",true);	// 1000원
		JRadioButton jr5 = new JRadioButton("치즈");		// 500원
		JRadioButton jr6 = new JRadioButton("페퍼로니");	// 1000원
		JRadioButton jr7 = new JRadioButton("베이컨");	// 1500원
		...
		JRadioButton jr8 = new JRadioButton("Small");		// 0.8배
		JRadioButton jr9 = new JRadioButton("Medium",true);	// 기본
		JRadioButton jr10 = new JRadioButton("Large");		// 1.2배
